...
class GigCreateForm(forms.ModelForm):
    ...
    def send_email(self):
        ...
        send_mail('New gig offer!', 'Hello! You have a new gig offer from {} {} on GigForte :) Sign in to your account! https://gig-forte-1.herokuapp.com/'.format(bandleader_first_name, bandleader_last_name), 'tamara.dement@gmail.com', email_addresses, fail_silently=False)
